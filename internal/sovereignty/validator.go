...
// Sovereignty cannot be downgraded: strict > regional > global.
const (
	LevelStrict  = "strict"
...
func ValidLevels() []string {
	return []string{LevelStrict, LevelRegional, LevelGlobal}
}
...
func (e *DowngradeError) Error() string {
	return fmt.Sprintf(
		"sovereignty cannot be downgraded from %q (rank %d) to %q (rank %d); "+
			"HarchOS enforces strict > regional > global escalation policy",
...
func (v SovereigntyValidator) Description(_ context.Context) string {
	return "validates that sovereignty is one of: strict, regional, global; and cannot be downgraded"
}
...
func (v SovereigntyValidator) MarkdownDescription(_ context.Context) string {
	return "Validates that sovereignty is one of: `strict`, `regional`, `global`. " +
		"Enforces escalation policy: sovereignty cannot be downgraded (strict > regional > global)."
}
...
// are valid (strict, regional, global).
